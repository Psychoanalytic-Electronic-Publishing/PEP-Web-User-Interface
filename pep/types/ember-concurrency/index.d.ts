declare module 'ember-concurrency' {
    ...
    type GeneratorFn<Args extends any[] = any[], R = any> = (...args: Args) => IterableIterator<R>;
    ...
    export function didCancel(errors: Error | Error[]): boolean;
    ...
    export function task<Args extends any[], R>(task: GeneratorFn<Args, R>): Task<Args, Exclude<R, Promise<any>>>;
